        ...
        <div class="container-fluid p-4">
            ...
            <div class="row" v-for="t in filterTasks" v-bind:key="t.action">
                ...
                <div class="col-2 text-center">
                    <input type="checkbox" v-model="t.done" class="form-check-input" title="是否完成">
                    {{t.done}}
                </div>
            </div>
            <div class="row py-2">
                <div class="col">
                    <input v-model="newItemText" class="form-control" title="add new todo"/>
                </div>
                <div class="col-2">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                name: "Adam",
                tasks: [{action: "abc", done: false},
                    {action: "zsc", done: false},
                    {action: "liata", done: true},
                    {action: "zhang", done: false}],
                hideCompleted: true,
                newItemText:""
            }
        },
